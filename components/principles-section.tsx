  ...
  const principles = [
    {
      number: "01",
      titleParts: [
        { text: "INDUSTRIAL", highlight: true },
        { text: " INNOVATION", highlight: false },
      ],
      description: "Gen AI Intern at TCS. Focused on Large Language Model integration and pipeline scalability.",
      align: "left",
    },
    {
      number: "02",
      titleParts: [
        ...
        { text: " MENTORSHIP", highlight: false },
      ],
      description: "DSA Mentor at Noobuild. Guiding developers through algorithmic optimization and efficient computing.",
      align: "right",
    },
    {
      number: "03",
      titleParts: [
        { text: "LOW-LATENCY ", highlight: false },
        { text: "AI", highlight: true },
      ],
      description: "Engineered KRISHAK achieving a 3-second response latency across 36+ states.",
      align: "left",
    },
    {
      number: "04",
      titleParts: [
        { text: "SEMANTIC ", highlight: false },
        { text: "PRECISION", highlight: true },
      ],
      description: "Utilized LangChain and FAISS, improving query resolution speeds by 30%.",
      align: "right",
    },
  ]
